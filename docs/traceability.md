...
| DEC-04 |  |  |  | not_started |
| DEC-05 | REF-24, REF-21, REF-10, REF-16, REF-33 | src/tere4ai/align_hleg_altai/__main__.py, src/tere4ai/align_hleg_altai/hleg_nodes.py, src/tere4ai/align_hleg_altai/pipeline.py | tests/unit/test_align_hleg.py | partial (mapping judge; target-side HLEG nodes; assertions arrive with the mapping pipeline; mapping judge) |
