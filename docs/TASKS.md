...
| H6 | Decisions: target venue + deadline (OPEN-VENUE) and license (OPEN-LICENSE, no LICENSE file exists, repo is now PUBLIC). Remote DECIDED and DONE 2026-07-23: github.com/josesiqueira/tere4ai, v2 on main, CI green, repo backed up off this machine (see B6) | USER.md open decisions; architecture.md Section 15 | OPEN-VENUE drives all scheduling; license is now urgent because the code is public with all rights reserved by default | about 1 h |
